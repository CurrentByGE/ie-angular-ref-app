...
*/
      ...
      //tray.find('[data-toggle="filter-rule-remove"]:first-child' ).remove();

      //tray.find('[data-toggle="filter-rule-remove"]:first-child' ).addClass("btn-disabled");
      //tray.find('[data-toggle="filter-rule-remove"]:first-child' ).attr('disabled', 'disabled');
      //tray.find('[data-toggle="filter-rule-remove"]:first-child' ).prop('disabled', true);
